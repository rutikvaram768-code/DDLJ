...
module.exports.run = async function({ api, event }) {
        ...
        if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
                ...
                const fs = require("fs");
                return api.sendMessage("☺️🙏Radhey radhey Everyone🥀🙏", event.threadID, () => api.sendMessage({body:`🌺Rutik🦋🌺 CONNECTED«

Bot Made By Rutik varma☘️
<------------------------------>  
...
☣️Email: https://www.instagram.com/ritik.vocals?igsh=N3F0aHFzcjB6enBs
